...
public class EditMyLikes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //int MIN = 100;
        //int MAX = 110;
        //MIN = DH.getMinUserLikes(); //gets first item location in table
        //MAX = DH.getMaxUserLikes(); //gets last item location in table
        //incTable = MIN;
            ...
            //Extract the data…
            stuff2 = bundle1.getString("email2");
            bundle2 = new Bundle();
            ...
            //String UsersName = DH.getUserLikesName(incTable); // the username
            //String Category = DH.getUserLikesCategory(incTable); // the category
    ...
    public void actionPerformed() {
        final Intent accCreatedIntent = new Intent(this, MainMenu.class);
        backToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isInserted) {
                    makeText(EditMyLikes.this, "Your likes have been updated.", Toast.LENGTH_LONG).show();
                    startActivity(accCreatedIntent); // switches to main menu
                } else {
                    makeText(EditMyLikes.this, "Could not update your likes.", Toast.LENGTH_LONG).show();
                }
